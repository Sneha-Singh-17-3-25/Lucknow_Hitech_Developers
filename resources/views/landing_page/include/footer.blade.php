     ...
     <div class="max-w-screen-xl mx-auto px-4">
         <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
             ...
             <div>
                 ...
                 <ul class="space-y-3">
                     <li><a href="{{route('landing_index')}}"
                             class="text-gray-400 hover:text-saffron transition-colors">Home</a>
                     </li>
                     <li><a href="{{route('landing_about')}}"
                             class="text-gray-400 hover:text-saffron transition-colors">About
                             Us</a>
                     </li>
                     ...
                     <li><a href="{{route('landing_contact')}}"
                             class="text-gray-400 hover:text-saffron transition-colors">Contact
                             Us</a>
                     </li>
