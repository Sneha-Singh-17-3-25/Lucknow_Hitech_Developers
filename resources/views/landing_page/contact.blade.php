...
<body class="font-sans text-slate bg-gray-50">
    ...
    <section id="contact-section" class="py-16 bg-white">
        <div class="w-11/12 max-w-screen-xl mx-auto">
                ...
                <div class="bg-white rounded-lg shadow-md p-8 slide-in">
                    ...
                    <form id="contact-form" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <input type="hidden" name="access_key" value="57e41547-c1b9-4e8d-b8fd-b89b86ad094f">
                            <div>
            ...
            <!-- <form id="contact-form" class="bg-white rounded-lg shadow-md p-8 slide-in space-y-6" action="https://api.web3forms.com/submit" method="POST">
                 <h3 class="text-2xl font-heading font-bold text-slate mb-6">
                     Send us a <span class="text-saffron">Message</span>
                 </h3>
                 ...
                 <div>
                     <label for="property-type" class="block text-sm font-medium text-gray-700 mb-1">Property Interest</label>
                     <select id="property-type" name="property-type"
                         class="w-full px-4 py-3 rounded-md border contact-input focus:outline-none appearance-none bg-white">
                         <option value="">Select Property Type</option>
                         <option value="residential">Residential</option>
                 ...
                 <div class="flex items-center">
                     <input type="checkbox" id="newsletter" name="newsletter" class="mr-2 h-4 w-4 text-saffron">
                     <label for="newsletter" class="text-sm text-gray-700">Subscribe to our newsletter for property
                         updates</label>
                 </div>
